...
export const PIPELINE_ID = 'reviewminer-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 · Paste reviews / CSV snippet",
  process: "Step 2/3 · Mine sentiment & aspects",
  output: "Step 3/3 · Theme + sentiment summary",
}
