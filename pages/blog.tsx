...
const howToSteps = [
  { name: 'Paste reviews', text: 'Provide a representative set of customer reviews.' },
  { name: 'Mine themes and sentiment', text: 'Extract aspect themes and a sentiment summary.' },
  { name: 'Act on top themes', text: 'Turn recurring issues into backlog or CX actions.' },
]
...
export default function Page() {
  ...
  const SHORT = "ReviewMiner turns a pile of customer reviews into sentiment and theme summaries."
  return (
    <>
      <Head>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-lg font-semibold text-slate-900" data-geo-short-lead="1">ReviewMiner turns a pile of customer reviews into sentiment and theme summaries.</p>
