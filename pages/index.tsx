  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://reviewminer.lxsaihub.com/" />
      
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is ReviewMiner?", "acceptedAnswer": {"@type": "Answer", "text": "ReviewMiner mines customer reviews for sentiment splits and recurring themes."}}, {"@type": "Question", "name": "What do I paste in?", "acceptedAnswer": {"@type": "Answer", "text": "A set of reviews or a CSV-like snippet with enough volume to analyze."}}, {"@type": "Question", "name": "Who should use it?", "acceptedAnswer": {"@type": "Answer", "text": "Product and CX teams scanning qualitative feedback."}}, {"@type": "Question", "name": "Does it invent quotes?", "acceptedAnswer": {"@type": "Answer", "text": "No. Treat outputs as analysis; keep original reviews as source of truth."}}, {"@type": "Question", "name": "How many reviews do I need?", "acceptedAnswer": {"@type": "Answer", "text": "More is better; very small samples get honesty warnings."}}, {"@type": "Question", "name": "Does it guarantee accuracy?", "acceptedAnswer": {"@type": "Answer", "text": "No. It is decision-support summarization, not a certified research study."}}]}` }} />
        </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">ReviewMiner - definition</h2>
